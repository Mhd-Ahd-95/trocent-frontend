...
export default makeStyles({ name: 'Billing' })((theme) => {
    ...
    return {
        ...
        registeredRowScroll: {
            ...
            [theme.breakpoints.down('md')]: {
                ...
                '&::-webkit-scrollbar-thumb': {
                    background: isDark ? alpha('#fff', 0.15) : alpha(secondary, 0.2),
                    borderRadius: 3,
                },
            },
        },
        ...
        registeredRowRegistered: {
            borderColor: isDark ? alpha('#fff', 0.08) : alpha(secondary, 0.1),
        },
        registeredRowUnregistered: {
            borderColor: alpha(error, 0.35),
            background: isDark ? alpha(error, 0.06) : alpha(error, 0.04),
        },
        registeredRowSelected: {
        ...
        registeredRowCheckbox: {
            flex: '0 0 auto',
            display: 'flex',
            alignItems: 'center',
        },
        registeredRowIdentity: {
            minWidth: 0,
        },
        registeredRowCompany: {
            fontSize: 14.5,
            fontWeight: 800,
            color: isDark ? '#fff' : '#0f172a',
            // whiteSpace: 'nowrap',
        ...
        registeredRowFinancials: {
            display: 'flex',
            gap: theme.spacing(6),
        },
        registeredRowDateBlock: {
            textAlign: 'left',
            minWidth: 100,
        },
        registeredRowDateLabel: {
            fontSize: 12,
            fontWeight: 700,
            textTransform: 'uppercase',
            letterSpacing: '0.04em',
        ...
        registeredRowDateValue: {
            fontSize: 14,
            fontWeight: 700,
            color: isDark ? '#fff' : '#0f172a',
            whiteSpace: 'nowrap',
        },
        registeredRowTotalValue: {
            fontSize: 16,
            fontWeight: 800,
            color: primary,
            whiteSpace: 'nowrap',
        ...
        registeredRowErrorNote: {
            display: 'flex',
            alignItems: 'center',
            gap: 4,
            fontSize: 10.5,
            fontWeight: 600,
            color: alpha(error, 0.85),
            maxWidth: 220,
            whiteSpace: 'nowrap',
            overflow: 'hidden',
            textOverflow: 'ellipsis',
