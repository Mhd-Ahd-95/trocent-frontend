        ...
        <Box className={classes.overlay}>
            <Card className={classes.card} elevation={10}>
                <CardHeader
                    ...
                    avatar={
                        <Box sx={{ width: 36, height: 36, borderRadius: 2.5, bgcolor: "warning.soft", border: "1px solid", borderColor: "warning.light", display: "flex", alignItems: "center", justifyContent: "center" }}>
