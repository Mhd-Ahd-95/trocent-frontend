...
import { Typography, Chip, Link, TableRow, TableCell, Divider, Tooltip, alpha, Box } from '@mui/material';
...
const cellSx = { py: 0.5, px: 1.5, borderBottom: '1px solid', borderColor: 'divider', verticalAlign: 'middle' };
            ...
            >
                <TableCell sx={{ ...cellSx, minWidth: 180, borderRight: '1px solid #ccc', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <Typography variant="caption" color="text.secondary" display="block" noWrap sx={{ maxWidth: 180 }}>
                        {row.reference_numbers ? row.reference_numbers[0] : '-'}
                    </Typography>
                    <Typography variant="caption" color="text.secondary" display="block">
                        {moment.utc(row.order_date || new Date()).format('ddd, DD/MM/YYYY')}
                    </Typography>
